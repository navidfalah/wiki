...
tags:
  ...
  - resources-enginepy
  - wiki
last_updated: "2026-09-10T14:41:09.240704+00:00"
...
- **[Resources Engine](./resources-engine.md) (`resources_engine.py`)**: 
...
- **Chat / [RAG Engine](./rag-engine.md) (`rag_engine.py`)**:
  ...
  - `retrieve_hybrid(..., llm=)` fuses embedding similarity and an LLM reranker when a key is configured, degrading gracefully tier-by-tier otherwise (detailed further in `25-hybrid-retrieval.md`).
