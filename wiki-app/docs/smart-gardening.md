...
tags:
  ...
  - nova-widget
  - nrf52840
last_updated: "2026-06-25T07:57:40.571563+00:00"
sidebar_label: Smart Gardening
...
*   **Data Ownership**: A fundamental principle ensuring users have complete control and access to the data collected by their smart gardening devices.
*   **Mesh Networking**: A network topology where each node relays data for the network, allowing for greater range and reliability, as implemented via MeshSync.
*   **Open Sensors**: Sensors designed with open specifications or open-source components, promoting transparency and user control.
