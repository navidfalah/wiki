...
- **Intro** — mentioned in source
- **SenseNode SN-400** — mentioned in source
- **Aurora [Nova Widget v2](/docs/entities/nova-widget-v2) (beta unit)** — mentioned in source
- **Verdict** — mentioned in source
- **Correction (2026-05-21 update)** — mentioned in source
