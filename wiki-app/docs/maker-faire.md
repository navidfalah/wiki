...
tags:
  ...
  - mqtt-schema-v2
  - nodes-max
last_updated: "2026-06-25T07:38:25.787613+00:00"
sidebar_label: Maker Faire
slug: /maker-faire
---
...
*   **MeshSync**: AuroraLabs' core technology, recently updated to version 0.3.8.
*   **MQTT Schema v2**: An updated messaging protocol schema implemented in MeshSync 0.3.8.
*   **Node Limits**: The recommended maximum number of devices (nodes) for a MeshSync network, particularly during beta phases.
*   **CR2032 / CR2450**: Types of coin cell batteries, with CR2032 confirmed for AuroraLabs' devices.
*   **Beta Program**: The phase of development where products are tested by a limited audience, often with specific recommendations like node limits.

## Contradictions

*   **Battery Type**: AuroraLabs clarified that CR2032 is the correct battery type for their devices, correcting an "old blog typo" that might have previously indicated CR2450. This is a correction of external information rather than a contradiction within the provided source.
