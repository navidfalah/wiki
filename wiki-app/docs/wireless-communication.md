...
Wireless communication is a fundamental aspect of modern [Internet of Things (IoT)](./internet-of-things.md) devices, enabling data exchange without physical cables. This page explores various wireless protocols and their applications, particularly in [sensor networks](./sensor-networks.md), focusing on [Mesh Networking](./mesh-networking.md) (e.g., [MeshSync](./meshsync.md)), [LoRaWAN](./lorawan.md), and [Bluetooth Low Energy (BLE)](./bluetooth-low-energy.md). Key considerations include [power consumption](./power-consumption.md), [battery life](./battery-life.md), [duty cycles](./duty-cycle.md), and network architecture (e.g., [local-first](./local-first-architecture.md) vs. cloud-dependent).

## Key Details

### MeshSync (Aurora Labs)

*   **Application**: Utilized by the [Nova Widget](./nova-widget.md) beta, a local mesh soil sensor developed by [Aurora Labs](./aurora-labs.md) ([Mira Chen](./mira-chen.md)).
...
*   **Power**: Nodes are powered by [CR2032 batteries](./cr2032-batteries.md), with a target of 15-minute read intervals. It aims for a lower [duty cycle](./duty-cycle.md) compared to [Wi-Fi](./wi-fi.md).
...
*   **Cost**: Often cited as winning on [Total Cost of Ownership (TCO)](./total-cost-of-ownership.md) due to the absence of subscriptions and no requirement for a [gateway](./gateway.md) wall wart (unlike [LoRaWAN](./lorawan.md)).
*   **Hardware**: Research into [nRF52840](./nrf52840.md) sleep modes suggests its use or consideration for [MeshSync](./meshsync.md) devices.
*   **Durability**: [Nova Widget](./nova-widget.md) is rated [IP54](./ip54.md), suitable for general use but not for submersion.
...
*   **Power**: [Gateways](./gateway.md) typically require always-on wall power (~2W). Nodes are subject to [duty cycle](./duty-cycle.md) limits, particularly in regions like the EU, which can necessitate longer effective intervals or higher peak power.
*   **Cost**: Often associated with subscription models, contributing to "subscription fatigue" among users.
*   **Durability**: [SenseNode](./sensenode.md) devices are known for an [IP67](./ip67.md) rating, making them suitable for submersion use cases.
...
*   **Duty Cycle**: A critical factor in [power consumption](./power-consumption.md), especially for [battery-powered devices](./battery-life.md). Different protocols have varying [duty cycle](./duty-cycle.md) limitations and implications.
*   **Battery Life**: A major concern for [IoT](./internet-of-things.md) devices. [CR2032 batteries](./cr2032-batteries.md) are commonly used, and "[battery math](./battery-life.md)" and [discharge curves](./cr2032-battery-discharge-curve.md) are important research areas.
...
*   **[Mira Chen](./mira-chen.md)**: Co-founder of [Aurora Labs](./aurora-labs.md).
*   **[TeaBuddy](./teabuddy.md)**: A product/company ([Alex Kim](./alex-kim.md)) that also uses [CR2032 batteries](./cr2032-batteries.md) and emphasizes [local-first](./local-first-architecture.md) principles.
*   **[SenseNode](./sensenode.md)**: A class of [LoRaWAN](./lorawan.md)-based sensor devices.
*   **[nRF52840](./nrf52840.md)**: A common microcontroller often used in [BLE](./bluetooth-low-energy.md) and [mesh networking](./mesh-networking.md) applications, known for its sleep modes.

## Related Concepts

*   [Mesh Networking](./mesh-networking.md)
*   [LoRaWAN](./lorawan.md)
*   [Bluetooth Low Energy (BLE)](./bluetooth-low-energy.md)
...
*   [Internet of Things (IoT)](./internet-of-things.md)
*   [Sensor Networks](./sensor-networks.md)
*   [IP Ratings](./ip-ratings.md) (Ingress Protection)
*   [CR2032 Battery Discharge Curve](./cr2032-battery-discharge-curve.md)
