...
tags:
  ...
  - issue-reporting
  - support
last_updated: "2026-06-25T07:31:44.391882+00:00"
sidebar_label: Issue Reporting
...
## Overview
Issue reporting is a critical process for identifying and resolving problems encountered with [Aurora Labs](./aurora-labs.md) products, particularly during [beta testing](./beta-testing.md) phases. Users are encouraged to report any issues they experience to help improve product stability and functionality.
...
## Related Entities
*   **Aurora Labs**: The organization developing the products.
*   **Aurora Nova Widget**: The specific product undergoing beta testing.
*   **GitHub**: A web-based platform used for version control and collaborative software development, including issue tracking.
