...
tags:
  ...
  - mesh-networking
  - mira
last_updated: "2026-06-25T07:33:56.392983+00:00"
sidebar_label: Local-first IoT
slug: /local-first-iot
---
...
## Related Entities
*   **Alex Kim**: Presenter from TeaBuddy.
*   **TeaBuddy**: Company developing consumer IoT gadgets, known for its local-first approach.
*   **Aurora Office**: Host location for the lunch-and-learn session.
*   **Mira**: Participant who provided insight on mesh networking for garden sensors.
*   **Jonah**: Participant who offered enclosure supplier contacts.
*   **Nova Widget**: Device used in the demonstration.

## Related Concepts
*   **BLE (Bluetooth Low Energy)**: A wireless personal area network technology designed for low power consumption.
*   **Mesh Networking**: A network topology where each node relays data for the network, allowing for greater range and reliability, often at the cost of increased complexity.
*   **Cloud Accounts**: User accounts managed by a remote server, typically used for data storage, remote control, and advanced features in IoT devices.
*   **Consumer Gadgets**: Electronic devices designed for personal use.
*   **Garden Sensors**: IoT devices used to monitor conditions in gardens, often requiring multiple units.
