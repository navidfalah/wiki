...
tags:
  ...
  - sensenode
  - teabuddy
last_updated: "2026-09-06T15:23:34.029468+00:00"
...
- **Replacing the Domain:**
  ...
  4. Update the title in `wiki-app/docusaurus.config.js` from "[Aurora Labs Wiki](./aurora-nova-widget.md)" to your desired title.
  5. Keep the `AGENTS.md` domain section synchronized if AI agents need awareness of your topic.
- **File Markers:**
...
- **[Aurora Labs](./aurora-labs.md)** — Mentioned in the default Docusaurus configuration title and inquired by [TeaBuddy](./teabuddy.md) regarding a shared [BLE](./ble.md) stack.
...
&gt; **Contradiction:** [Battery Life](./battery-life.md) estimates differ, with marketing claiming 2 years versus engineering projections of ~18 months at 10 nodes.
