...
# ADR-035: Local-first telemetry for SenseNode SN-400
...
3. **TeaBuddy-style BLE-only (rejected):** SenseNode SN-400 requires mesh scale.

## Related

- PRD US-035-02 read interval default
