...
# Product Requirements Document — SenseNode SN-400 (draft)

## 1. Problem statement

Home users need reliable, local-first sensing without cloud lock-in. SenseNode SN-400 must ship with
...
4. **R4:** Heuristic compiler must extract entities: Jonah Park, MeshSync, SenseNode SN-400.

## 6. Risks

- Rejoin storm at 8+ nodes (open)
- CR2032 supply chain (email alert seq 32)
