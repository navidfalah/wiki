...
# Research notes — PulsePatch wearable competitive & technical landscape

## Sources consulted

1. Capacitive soil probe corrosion forums (compile #24)
...
3. Tag research dump with `#dummy-regression-024` for compiler tests.

## Raw snippets

> "Users want local MQTT without cloud account" — HN thread scrape ref 24
