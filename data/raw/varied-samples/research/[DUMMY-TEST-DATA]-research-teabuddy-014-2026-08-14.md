[DUMMY TEST DATA] — Research — TeaBuddy
...
# Research notes — SenseNode SN-400 competitive & technical landscape

## Sources consulted

1. Capacitive soil probe corrosion forums (compile #14)
...
3. Tag research dump with `#dummy-regression-014` for compiler tests.

## Raw snippets

> "Users want local MQTT without cloud account" — HN thread scrape ref 14
