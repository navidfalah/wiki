...
1. Capacitive soil probe corrosion forums (compile #34)
...
3. Tag research dump with `#dummy-regression-034` for compiler tests.

## Raw snippets

> "Users want local MQTT without cloud account" — HN thread scrape ref 34
