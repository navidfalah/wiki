...
# Technical specification — PulsePatch wearable hardware rev D (fragment)
...
- Service UUID: fictional-aurora-001e
...
- SPEC-030-01: Document rejoin spike mitigation level
- SPEC-030-02: Align box QR URL with wiki quick-start
- SPEC-030-03: TeaBuddy cross-contamination in shared warehouse SKU labels
