...
# at what an image shows (same for an audio transcript), an extracted
# document sits in between, and a live web search hit (web_search.py, gated
# behind --web-search) is unvetted third-party content pulled in
# automatically, so it starts at the same "low" tier as an image caption.
