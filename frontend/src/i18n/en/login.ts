export const login = {
  ...
  'login.panel.badge': 'Non-commercial research project',
  'login.panel.title': 'Turn scattered documents into a wiki you can verify.',
  'login.panel.p1': 'Every answer names the sources behind it.',
  'login.panel.p2': 'Self-hosted, with no trackers.',
  'login.panel.p3': 'Available in English and German.',
  'login.showPassword': 'Show password',
  'login.hidePassword': 'Hide password',
  'login.noAccount': 'No account yet?',
  'login.requestAccess': 'Request access',
  'login.access': 'Access is limited to test accounts.',
} as const;
